...
With the upper bound of the integration determined, one can start to estimate the Casimir energy between two spheres with radius $r_1 = r_2 = 1$ at the 
...
\end{figure}
\footnotetext{The negative normalized Casimir energy is $-\xi/\hbar c$, for $\xi$ defined in \eqref{KSSF and CasE}. Note that for the labels in all the figures,
the normalized Casimir energy means the negative normalized.}
