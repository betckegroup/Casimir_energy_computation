...
The value of $\Xi(\mathrm{i}k) = \log\det(\mathrm{V}(\mathrm{i}k)\tilde{V}(\mathrm{i}k)^{-1})$ can now be explicitly computed by evaluating the corresponding log determinants.
