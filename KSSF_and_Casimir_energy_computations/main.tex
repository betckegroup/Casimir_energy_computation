...
the Casimir energy in three dimensional acoustic and electromagnetic scattering. Afterwards, we will discuss the spectral properties of the block matrices 
...
\section{Krylov subspace for generalized eigenvalue problem}\label{Krylov subspace for generalized eigenvalue problem}
