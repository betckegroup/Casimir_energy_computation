...
plot the number of actual matvecs with discretised integral operators for each individual Algorithm. The integral here has been discretized with {\text{color} XXX} quadrature
